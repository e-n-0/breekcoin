...
"""Verify that starting breekcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start breekcoin with -h for help text")
        ...
        self.log.info("Start breekcoin with -version for version information")
        ...
        self.log.info("Start breekcoind with -fakearg to make sure it does not start")
