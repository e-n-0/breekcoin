...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " breekcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  breekcoin-tx [options] <hex-tx> [commands]  Update hex-encoded breekcoin transaction\n" +
            "or:     breekcoin-tx [options] -create [commands]   Create hex-encoded breekcoin transaction\n" +
            "\n";
