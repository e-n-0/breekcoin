...
{
    const char* pszTimestamp = "9th January of 2022 - The start of a new life: Time to Breek";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1641742874, 2087637420, 0x1e0ffff0, 1, 18 * COIN);

        while(!CheckProofOfWork(genesis.GetPoWHash(), genesis.nBits, consensus))
        {
            int nTime = genesis.nTime;
            if(genesis.nNonce == 0)
                nTime++;

            genesis = CreateGenesisBlock(nTime, genesis.nNonce + 1, 0x1e0ffff0, 1, 18 * COIN);
            //printf("Mined hash: %s\n", genesis.GetHash().ToString().c_str());
        }

        printf("Find a valid genesis Block\n");
        printf("Hash: %s\n", genesis.GetHash().ToString().c_str());
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x902ef525bd5d6193d0511df4456c9389b38b5993def19718b5519c3b7e88fd12"));
        assert(genesis.hashMerkleRoot == uint256S("0x6314ef0b9ab5bbc13d27f0db7a9cc349a80613d0149cc2b1adc935813df7aade"));
        ...
        checkpointData = {
            {
                {  0, uint256S("0x6314ef0b9ab5bbc13d27f0db7a9cc349a80613d0149cc2b1adc935813df7aade")}
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1641742874, 0, 0x207fffff, 1, 18 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x425b6ce3279c6b6a04fc9d00a66c6da559f092860d6afafeaa184d5d5762ca5d"));
        assert(genesis.hashMerkleRoot == uint256S("0x6314ef0b9ab5bbc13d27f0db7a9cc349a80613d0149cc2b1adc935813df7aade"));
