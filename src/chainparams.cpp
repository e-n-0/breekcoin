...
{
    const char* pszTimestamp = "Breekcoin - Just 23 years old and ready for the 3rd vaccine dose for covid-19";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1642460400, 2084824508, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe5aa77bb326729a03c48e587c41d7a2e2ef9304a17a9146c39df53fce7ba0619"));
        assert(genesis.hashMerkleRoot == uint256S("0x183cddaf6cbc89204dcc113a3c4010fbf45379d6262d12f0bbff189717972ef4"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x18, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x18, 0x88, 0xAD, 0xE4};
        ...
        checkpointData = {
            {
                {  0, uint256S("0xe5aa77bb326729a03c48e587c41d7a2e2ef9304a17a9146c39df53fce7ba0619")}
