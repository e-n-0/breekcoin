# Support for Output Descriptors in Breekcoin Core

Since Breekcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Breekcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Breekcoin Core wallets, a convenience function `combo` is
